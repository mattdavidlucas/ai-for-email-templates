...
async function airtablePatch(path, payload) {
...
server.registerTool("list_bases", {
    ...
    description: "Returns all Airtable bases accessible with your Personal Access Token. " +
...
server.registerTool("list_tables", {
    ...
    description: "Returns all tables in an Airtable base, including their field schemas. " +
...
server.registerTool("list_records", {
    ...
    description: "Retrieves records from an Airtable table. Returns up to 100 records per call. " +
    ...
    inputSchema: {
        ...
        offset: z
            .string()
            .optional()
            .describe("Pagination token from a previous list_records response. Omit for the first page."),
    },
...
server.registerTool("get_record", {
    ...
    description: "Fetches a specific Airtable record by its record ID. " +
...
server.registerTool("update_record", {
    ...
    description: "Updates one or more fields on an existing Airtable record. " +
    ...
    inputSchema: {
        ...
        fields: z
            .record(z.unknown())
            .describe("Fields to update as a JSON object. Keys are field names, values are the new values. " +
...
server.registerTool("search_records", {
    ...
    description: "Finds records matching an Airtable filter formula. " +
