...
- **MCP:** When Figma released their MCP for Cursor, I immediately connected it, and started using it. When I paired it with Cursor's Plan Mode, the time savings were significant. Examples of the generated code can be viewed [here](/level-02/ck-email-module-samples/).
